...
- **In flight:** **M10 — A4 page layout + view toggle + print** (PRD §6.6) is **implemented and in review** (this PR). Next: **M11 — Drag-reorder chords**, then **M12 — Polish**.
...
| M10 | A4 page layout + view toggle + print                                    | 🔄 In review | _(PR pending)_                                       | _(pending)_           |
...
### M10 — A4 page layout + view toggle + print 🔄 (in review)
...
### M11–M12 ⏳ Planned — chord drag, polish
